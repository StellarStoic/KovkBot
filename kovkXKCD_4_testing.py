...
# wind_speed = [20,20,15,20,22,22,27,29,56,60,40,30,25,17,26,24,20,19]
wind_speed = [2,0,1,0,2,1,2,1,0,0,0,3,2,1,2,2,0,1]
...
with plt.xkcd():
    ...
    if max(temperature) < 0:
        ax1.set_ylabel('Matr je mrz!', fontsize='xx-small')
    elif min(temperature) > 18:
        ax1.set_ylabel('°C', fontsize='xx-small')
    else:
        ax1.set_ylabel('°C', fontsize='xx-small', zorder=1)
